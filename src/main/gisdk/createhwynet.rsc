...
macro "create hwynet"
   ...
   Opts.Global.[Link Options] = {{"Length", link_lyr+".Length", link_lyr+".Length"}, 
        ...
        {"*LDCST_EA", link_lyr+".ABLDCST_EA", link_lyr+".BALDCST_EA"}, 
        {"*LDCST_AM", link_lyr+".ABLDCST_AM", link_lyr+".BALDCST_AM"}, 
        {"*LDCST_MD", link_lyr+".ABLDCST_MD", link_lyr+".BALDCST_MD"}, 
        {"*LDCST_PM", link_lyr+".ABLDCST_PM", link_lyr+".BALDCST_PM"}, 
        {"*LDCST_EV", link_lyr+".ABLDCST_EV", link_lyr+".BALDCST_EV"}, 
        {"*LHDCST_EA", link_lyr+".ABLHDCST_EA", link_lyr+".BALHDCST_EA"}, 
        {"*LHDCST_AM", link_lyr+".ABLHDCST_AM", link_lyr+".BALHDCST_AM"}, 
        {"*LHDCST_MD", link_lyr+".ABLHDCST_MD", link_lyr+".BALHDCST_MD"}, 
        {"*LHDCST_PM", link_lyr+".ABLHDCST_PM", link_lyr+".BALHDCST_PM"}, 
        {"*LHDCST_EV", link_lyr+".ABLHDCST_EV", link_lyr+".BALHDCST_EV"}, 
        {"*MHDCST_EA", link_lyr+".ABMHDCST_EA", link_lyr+".BAMHDCST_EA"}, 
        {"*MHDCST_AM", link_lyr+".ABMHDCST_AM", link_lyr+".BAMHDCST_AM"}, 
        {"*MHDCST_MD", link_lyr+".ABMHDCST_MD", link_lyr+".BAMHDCST_MD"}, 
        {"*MHDCST_PM", link_lyr+".ABMHDCST_PM", link_lyr+".BAMHDCST_PM"}, 
        {"*MHDCST_EV", link_lyr+".ABMHDCST_EV", link_lyr+".BAMHDCST_EV"}, 
        {"*HHDCST_EA", link_lyr+".ABHHDCST_EA", link_lyr+".BAHHDCST_EA"}, 
        {"*HHDCST_AM", link_lyr+".ABHHDCST_AM", link_lyr+".BAHHDCST_AM"}, 
        {"*HHDCST_MD", link_lyr+".ABHHDCST_MD", link_lyr+".BAHHDCST_MD"}, 
        {"*HHDCST_PM", link_lyr+".ABHHDCST_PM", link_lyr+".BAHHDCST_PM"}, 
        {"*HHDCST_EV", link_lyr+".ABHHDCST_EV", link_lyr+".BAHHDCST_EV"},  
